...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Lower |      |  Alt |  GUI | kana | Space|             | Enter|  BS  | GUI  | Alt  |      |Raise |
   * `------+      +---------------------------+             +---------------------------+      +------'
   */
  [_QWERTY] = LAYOUT_kc(
    ...
    LOWER,      LALT, LGUI,cKANA, LOSP,             RAEN, BSPC, RGUI, RALT,      RAISE
    ),
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      | PrtSc| Pause| eisu |      |             |      |  DEL | Pause| PrtSc|      |      |
   * `------+      +---------------------------+             +---------------------------+      +------'
   */
  [_RAISE] = LAYOUT_kc(
    SLP,    F1,   F2,   F3,   F4,   F5,               F6,   F7,   F8,   F9,  F10,  DEL,
    ...
    ____,       PSCR, PAUS,xEISU, ____,             ____,  DEL, PAUS, PSCR,       ____ 
    ),
  [_LOWER] = LAYOUT_kc(
    SLP,    F1,   F2,   F3,   F4,   F5,               F6,   F7,   F8,   F9,  F10,  DEL,
    ESC , EXLM,   AT, HASH,  DLR, PERC,  F11,  F12, CIRC, AMPR, ASTR, LPRN, RPRN,  INS,
    ____, HOME, XXXX, UP,   XXXX, PGUP, XXXX, XXXX, PGUP, XXXX,   UP, XXXX, HOME, ____,
    ____, END,  LEFT, DOWN, RGHT, PGDN, XXXX, XXXX, PGDN, LEFT, DOWN, RGHT,  END, ____,
    ____,       PSCR, PAUS,xEISU, ____,             ____,  DEL, PAUS, PSCR,       ____ 
    ),
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | CAPS |  F1  |  F2  |  F3  |  F4  |  F5  |  F11 |  F12 |  F6  |  F7  |  F8  |  F9  |  F10 |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |      |      |      |      |      |      |      |      |      |      |      |      |      |      |
  ...
  [_ADJUST] =  LAYOUT_kc(
    ...
    CAPS,   F1,   F2,   F3,   F4,   F5,  F11,  F12,   F6,   F7,   F8,   F9,  F10, XXXX,
