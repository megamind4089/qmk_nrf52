...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,             KC_B,          S(KC_RBRC),    KANJI, S(KC_BSLS), KC_N,             KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,\
                         KC_LALT, LT(META, KC_SPC), SFT_T(KC_SPC), LT(CTRL, KC_TAB), KC_LGUI, KC_BSPC,    LT(META, KC_ENT), KC_DELT \
  ),

  [META] = LAYOUT( \
    _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,      _______, KC_7,    KC_8,    KC_9,  KC_0,    KC_MINS, KC_EQL  , \
