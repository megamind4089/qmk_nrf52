...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    CTL_T(KC_TAB),   KC_A,    KC_S,   KC_D,    KC_F,             KC_G,          S(KC_8),       S(KC_9),    KC_H,             KC_J,    KC_K,     KC_L,     KC_SCLN,  KC_QUOT, \
    KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,             KC_B,          S(KC_RBRC),    KANJI, S(KC_BSLS), KC_N,             KC_M,    KC_COMM,  KC_DOT,   KC_SLSH,\
                         KC_LALT, LT(META, KC_SPC), SFT_T(KC_SPC), LT(CTRL, KC_TAB), KC_LGUI, KC_BSPC,    KC_ENT, KC_DELT \
  ),
   ...
   */
  [META] = LAYOUT( \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,              _______, KC_7,    KC_8,    KC_9,  KC_0,    KC_MINS, KC_EQL  , \
    _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   _______,          _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, XXXXXXX, \
    _______, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,   KC_F6,            KC_F7,   KC_F8,   KC_F9, KC_F10,  KC_F11,  KC_F12,  SFT_T(KC_RO), \
  ...
  [GAME] = LAYOUT( \
    ...
    KC_LSFT,  KC_Z,    KC_X,   KC_C,    KC_V,   KC_B,   S(KC_RBRC), S(KC_BSLS), KC_N,   KC_M,    KC_COMM,  KC_DOT,  KC_SLSH, SFT_T(KC_RO), \
     KC_PSCR, KC_ESC, KC_SPC, KC_TAB,     KC_BSPC,    KC_ENT, KC_DELT, KC_PSCR  \
  ),
